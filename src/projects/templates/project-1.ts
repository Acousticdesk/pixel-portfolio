...
export const project1Template = `
  ...
  <ul class="project__list">
    ...
    <li>Foster a positive team culture, encouraging collaboration, knowledge sharing, and innovation</li>
    ...
    <li>Ensure adherence to coding standards, best practices, and quality assurance processes</li>
